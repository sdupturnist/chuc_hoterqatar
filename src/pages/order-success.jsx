                ...
                <div className="container [&>*]:text-black">
                    <div className="mx-auto 2xl:w-[70%] xl:w-[80%] h-[80vh] sm:w-[80%] w-[90%] flex justify-center items-center text-center">
                      ...
                      <h1 className='lg:text-[4vw] sm:text-[50px] text-[22px] leading-[34px] sm:font-normal font-semibold'>Thank you for your order!</h1>
                            ...
                            <Link title="Back to home" aria-label="Back to home" href={frontendUrl} className="btn border border-black border-solid bg-black hover:bg-gray-900 hover:border-black rounded-[6px] sm:max-w-[170px] min-w-[170px] min-h-[60px] text-white mx-auto">Back to home</Link>
